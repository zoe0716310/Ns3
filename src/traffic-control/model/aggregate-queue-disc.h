...
#ifndef AGGREGATE_QUEUE_DISC_H
#define AGGREGATE_QUEUE_DISC_H
 ...
 *
 */
class AggregateQueueDisc : public QueueDisc
{
  public:
    /**
    ...
    /**
     * \brief AggregateQueueDisc constructor
     *
     * Creates a queue with a depth of 1000 packets by default
     */
    AggregateQueueDisc();

    ~AggregateQueueDisc() override;

    void SetAggregateSsh(uint32_t threshold);

    uint32_t GetAggregateSsh() const;
