                ...
                if (src_info.first == "10.0.11.2") { // if packet is ACK
                    ...
                    if (it != CountMap.end()){ // seq in CountMap
                        ...
                        if (UpdateMap(pkt, Worker)){
                            ...
                            uint8_t aggregate_payload[200]; //payloadSize
                            ...
                            // create new pkt
                            Ptr<Packet> newPacket = Create<Packet>(aggregate_payload, payloadSize);
                        ...
                        if (!UpdateTable(pkt, Worker)){
                            setBit(hasSent, Worker);
                            CountMap[pkt.seq].set();
                            CountMap[pkt.seq][--Worker] = 0;
                        ...
                        if (AggregateParam.first){
                            ...
                            averageOccupy = averageOccupy / timeMap.size();
